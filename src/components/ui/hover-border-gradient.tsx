...
>) {
  ...
  return (
    <Tag
      ...
      className={cn(
        "relative flex content-center bg-background/80 hover:bg-background/90 transition-colors duration-300 items-center flex-col flex-nowrap gap-10 h-min justify-center overflow-visible p-px decoration-clone w-fit",
        containerClassName
      )}
      {...props}
    >
      <div
        className={cn(
          "w-auto text-foreground z-10 px-4 py-2 rounded-[inherit] flex items-center gap-2",
          className
        )}
      >
        {children}
